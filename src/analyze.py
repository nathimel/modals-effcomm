...
def main():
    if len(sys.argv) != 7:
        ...
        print("Usage: python3 src/analyze.py path_to_config path_to_space path_to_artificial_languages path_to_natural_languages path_to_save_dataframe path_to_save_plot")
