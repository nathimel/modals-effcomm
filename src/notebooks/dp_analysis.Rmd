...
# df <- read_csv("/Users/nathanielimel/uw/projects/modals-effcomm/outputs/universe=experiment_prohibition/prior=1e-20/utility=importance/agent_type=literal/analysis/all_data.csv")
...
# Be careful, this might not always be the case
...
plot = (
  ...
  + geom_point(  # naturals and variants
