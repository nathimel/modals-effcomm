...
# Example: ./scripts/main_results.sh configs/main_results/config.yml outputs/main_results/meaning_space.yml outputs/main_results/expressions.yml outputs/main_results/artificial_languages.yml data/natural_languages outputs/main_results/dataframe.csv outputs/main_results/plot.png
...
python3 src/analyze.py $CONFIG $MEANING_SPACE_SAVE_FILE  $ARTIFICIAL_LANGUAGES_SAVE_FILE $NATURAL_LANGUAGES_SAVE_FILE $DATAFRAME_SAVE_FILE $PLOT_SAVE_FILE
