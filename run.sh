...
./scripts/run_full_experiment.sh configs/indicator_literal.yml > outputs/indicator_literal.out
./scripts/run_full_experiment.sh configs/indicator_pragmatic.yml > outputs/indicator_pragmatic.out
./scripts/run_full_experiment.sh configs/half_credit_literal.yml > outputs/half_credit_literal.out
./scripts/run_full_experiment.sh configs/half_credit_pragmatic.yml > outputs/half_credit_pragmatic.out
